        ...
        <section class="w-full max-w-2xl flex flex-col rounded-2xl p-8 shadow-xl transition-colors duration-100 bg-white text-gray-900 border border-gray-200">
          ...
          <div class="mb-8">
            ...
            <div class="relative w-full h-6">
              ...
              <div
                class="absolute top-1/2 transform -translate-y-1/2 h-2 rounded-full bg-[var(--color-primary)]"
          ...
          <ul class="space-y-2 text-sm mb-8 flex-1">
            <li v-for="item in [
              ...
              <svg class="text-[var(--color-primary)] mr-2 mt-0.5 w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
              </svg>
              {{ item }}
            </li>
